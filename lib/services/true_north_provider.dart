...
class TrueNorthProvider with ChangeNotifier {
  ...
  void startListening() {
    ...
    if (kDebugMode) {
      print('🧭 TrueNorthProvider: リスニング開始');
    }
  }
  ...
  void updateLocation(double latitude, double longitude) {
    ...
    if (kDebugMode) {
      print('🧭 偏角更新: ${_currentDeclination.toStringAsFixed(2)}° (${latitude.toStringAsFixed(4)}, ${longitude.toStringAsFixed(4)})');
    }
  ...
  void stopListening() {
    ...
    if (kDebugMode) {
      print('🧭 TrueNorthProvider: リスニング停止');
    }
  }
...
///   print('大崎市の偏角: ${declination.toStringAsFixed(2)}°');
///   
///   // 期待値: -8.5度前後
...
///   print('高速参照: ${quickDec.toStringAsFixed(2)}°');
///   
///   // 真方位変換テスト
...
///   print('Provider偏角: ${provider.currentDeclination.toStringAsFixed(2)}°');
///   
///   print('✅ 全テスト通過');
/// }
/// ```
