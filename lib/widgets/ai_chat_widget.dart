...
class _AIChatWidgetState extends State<AIChatWidget> {
  ...
  void initState() {
    super.initState();
    _aiMessage = AppLocalizations.lang == 'ja'
    ...
    // Note: Ideally this init message should also be in AppLocalizations, 
  ...
  Future<void> _handleUserSelection(String type, String label) async {
    ...
    setState(() {
      _isAnalyzing = true;
      _aiMessage = AppLocalizations.t('bot_analyzing');
    });
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        AppLocalizations.t('bot_dest_set').replaceAll('@name', newTarget.name),
                                      ),
                                ...
                                label: Text(
                                  AppLocalizations.t('bot_go_to').replaceAll('@name', _foundShelter?.name ?? ''),
                                  maxLines: 1,
