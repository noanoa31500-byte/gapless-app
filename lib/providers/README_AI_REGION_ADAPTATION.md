...
**ファイル**: [`region_mode_provider.dart`](file:///Users/kusakariakiraakira/Desktop/SafeJapan/lib/providers/region_mode_provider.dart)
...
- [`region_mode_provider.dart`](file:///Users/kusakariakiraakira/Desktop/SafeJapan/lib/providers/region_mode_provider.dart) - 地域モード管理
- [`developer_mode_manager.dart`](file:///Users/kusakariakiraakira/Desktop/SafeJapan/lib/utils/developer_mode_manager.dart) - イースターエッグ
- AI Chat画面（統合先）
- 設定画面（トリガー実装先）
