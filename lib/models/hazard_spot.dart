...
class HazardSpot {
  ...
  String toCompactJson() => jsonEncode({
    ...
    's': status == 'unconfirmed' ? 0 : status == 'confirmed' ? 1 : 2,
    'r': reportCount,
  });
  ...
  factory HazardSpot.fromCompactJson(Map<String, dynamic> json) {
    ...
    return HazardSpot(
      ...
      timestamp: DateTime.fromMillisecondsSinceEpoch(
        ((json['t'] as num) * 1000).toInt(), isUtc: true),
      status: statusInt == 0 ? 'unconfirmed' : statusInt == 1 ? 'confirmed' : 'resolved',
