  ...
  Widget _buildLogo() {
    return Column(
      children: [
        ...
        // サブタイトル
        Text(
          AppLocalizations.t('splash_subtitle'),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                AppLocalizations.t('splash_disclaimer_title'),
          ...
          // 本文（日本語）
          Text(
            AppLocalizations.t('splash_disclaimer_jp'),
          ...
          // 本文（英語）
          Text(
            AppLocalizations.t('splash_disclaimer_en'),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    AppLocalizations.t('splash_warning'),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: _isInitialized
            ? Text(
                AppLocalizations.t('splash_agree'),
            ...
            : Row(
                ...
                children: [
                  ...
                  Text(
                    AppLocalizations.t(_loadingKey),
