          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                // 3. Emergency ID Card
                _buildSectionHeader(Icons.badge_rounded, AppLocalizations.t('header_emergency_gear')),
                const SizedBox(height: 12),
                _buildEmergencyIdCard(context),
                const SizedBox(height: 32),
                
                // 4. Survival Guide Grid
                _buildSectionHeader(Icons.menu_book_rounded, AppLocalizations.t('header_survival_guide')),
                const SizedBox(height: 12),
  ...
  Widget _buildSliverAppBar(BuildContext context) {
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        centerTitle: true,
        title: Text(
          AppLocalizations.t('header_shelter_support'),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        AppLocalizations.t('header_safe_banner_title'),
                      ...
                      Text(
                        AppLocalizations.t('header_safe_banner_desc'),
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildQuickActionButton(
            ...
            label: AppLocalizations.t('btn_show_staff'),
          ...
          _buildQuickActionButton(
            ...
            label: AppLocalizations.t('btn_talk_ai'),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  profile.name.isNotEmpty ? profile.name : AppLocalizations.t('label_unknown'),
                ...
                _buildInfoRow(
                  '${AppLocalizations.t('label_blood')}:',
                  profile.bloodType.isNotEmpty ? profile.bloodType : '-',
                  AppleColors.dangerRed,
                ),
                const SizedBox(height: 4),
                _buildInfoRow(
                  '${AppLocalizations.t('label_allergies')}:',
                  profile.allergies.isNotEmpty ? profile.allergies.join(', ') : AppLocalizations.t('label_unknown'),
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  AppLocalizations.t('btn_talk_ai'),
                  style: AppleTypography.headline.copyWith(
                    color: Colors.white,
                  ),
                ),
