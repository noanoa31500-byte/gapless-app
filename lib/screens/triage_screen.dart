...
class _TriageScreenState extends State<TriageScreen> {
  ...
  String _getTitle(String lang) {
    return AppLocalizations.t('triage_title');
  }
  ...
  String _getBackLabel(String lang) {
    return AppLocalizations.t('triage_back');
  }
  ...
  String _getRecommendationTitle(String lang) {
    return AppLocalizations.t('triage_recommendation');
  }

  String _getGoToHospitalLabel(String lang) {
    return AppLocalizations.t('triage_go_hospital');
  }

  String _getGoToShelterLabel(String lang) {
    return AppLocalizations.t('triage_go_shelter');
  }

  String _getRestartLabel(String lang) {
    return AppLocalizations.t('triage_restart');
  }
  ...
  void _navigateToHospital() {
    ...
    if (userLoc == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(AppLocalizations.t('location_not_available'))),
      );
      return;
    }
