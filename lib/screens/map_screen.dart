...
class _MapScreenState extends State<MapScreen> {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Row(children: [
            ...
            Text(GapLessL10n.t('map_info_added'),
      ...
      appBar: AppBar(
        ...
        title: Text('🗺️ ${GapLessL10n.t('map_title')}',
            style: emergencyTextStyle(
                size: 20, isBold: true, color: Colors.white)),
        actions: [
          // BLE同期状態インジケーター
          ...
          return Stack(children: [
            FlutterMap(
              ...
              children: [
                ...
                PolygonLayer(
                  polygons: provider.hazardPolygons
                      .map((polygon) => Polygon(
                            points: polygon,
                            ...
                            child: GestureDetector(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Icon(_getMarkerIcon(shelter.type),
                                        color: _getMarkerColor(shelter.type),
                                        size: 30,
                                        shadows: const [
                                          Shadow(
                ...
                MarkerLayer(
                  markers: hazardSpots.map((spot) {
                    ...
                    final size =
                        (30.0 + spot.reportCount * 4.0).clamp(30.0, 60.0);
                    final opacity =
                        (0.7 + spot.reportCount * 0.05).clamp(0.7, 1.0);
                    return Marker(
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Row(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const SizedBox(width: 8),
                  Text(
                      GapLessL10n.t('shelter_count')
                          .replaceAll('@count', '${provider.shelters.length}'),
  ...
  Widget _buildBleSyncIndicator(BleSyncService bleService) {
    ...
    return Padding(
      ...
      child: Tooltip(
        message: isActive
            ? GapLessL10n.t('map_ble_syncing')
                    .replaceAll('@count', '$peerCount') +
                (lastSync != null
                    ...
                    children: [
                      Row(children: [
                        ...
                        Expanded(
                            child: Column(
                              ...
                              Text(
                                  '📍 ${_tappedPoint!.latitude.toStringAsFixed(5)}, ${_tappedPoint!.longitude.toStringAsFixed(5)}',
                      ...
                      Container(
                        ...
                        child: Row(children: [
                          ...
                          const SizedBox(width: 8),
                          Expanded(
                              child: Text(GapLessL10n.t('map_hazard_hint'),
                                  style: GapLessL10n.safeStyle(const TextStyle(
                                      fontSize: 12,
                                      color: Color(0xFF2E7D32))))),
                        ]),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: Text(
                              _isSubmitting
                                  ? GapLessL10n.t('map_submitting')
                                  : GapLessL10n.t('map_submit'),
                              style: GapLessL10n.safeStyle(const TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                  letterSpacing: 0.5))),
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
            ...
            children: [
              ...
              Row(children: [
                const Icon(Icons.warning_amber_rounded,
                    color: _warningColor, size: 32),
                const SizedBox(width: 12),
                Expanded(
                    child: Text(GapLessL10n.t('hazard_unconfirmed_title'),
                        style: emergencyTextStyle(
                            size: 20,
                            isBold: true,
              ...
              const SizedBox(height: 8),
              _buildInfoRow(Icons.schedule, GapLessL10n.t('label_timestamp'),
                  spot.timestamp.toLocal().toString().substring(0, 16)),
              const SizedBox(height: 8),
              _buildInfoRow(Icons.people, GapLessL10n.t('label_report_count'),
                  '${spot.reportCount}${GapLessL10n.t('unit_count')}'),
              const SizedBox(height: 8),
              _buildInfoRow(Icons.flag_outlined, GapLessL10n.t('label_status'),
                  GapLessL10n.t('unverified')),
            ]),
      ),
    );
  }
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
            ...
            children: [
              ...
              _buildInfoRow(Icons.category, GapLessL10n.t('label_type'),
                  _getShelterLabel(shelter.type)),
              ...
              _buildInfoRow(
                  Icons.check_circle,
                  GapLessL10n.t('label_status'),
                  shelter.verified
                      ? GapLessL10n.t('verified')
                      : GapLessL10n.t('unverified')),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: () => ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                          content:
                              Text(GapLessL10n.t('navigation_developing')))),
  ...
  Widget _buildInfoRow(IconData icon, String label, String value) =>
      Row(children: [
        ...
        Text('$label: ',
            style: emergencyTextStyle(
                size: 14, isBold: true, color: Colors.grey[700]!)),
  ...
  String _getShelterLabel(String type) =>
      GapLessL10n.translateShelterType(type);
}
