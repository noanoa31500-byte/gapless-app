...
- **実装地域:**
  ...
  - 🇹🇭 **サトゥン県**: タイの洪水多発地域
- **言語:** 日本語・英語・タイ語・中国語（簡/繁）・韓国語・ミャンマー語・シンハラ語・デーヴァナーガリー・ベンガル語
...
> **注意:** ハザードデータ（GeoJSON・GISファイル）はリポジトリに含まれません。
> 外部ストレージまたはCDNから取得してください。
...
- [x] **コンパス画面ロック**（通信回復まで離脱不可・PopScope + connectivity監視）
...
- [x] 多言語UI（日・英・泰・中・韓 他）
- [x] 多言語フォント内蔵（NotoSans 10言語・オフライン対応）
- [x] パニックモード（振動・音声）
- [x] オフライン動作（データ事前キャッシュ）
- [x] 道路状況クラウドソーシング（BLE経由でP2P共有）
- [x] 包括的ランタイムバグ修正（全ファイル監査済み）
